        ...
        namespace MuhammedsBooks.DataAccess.Repository
{
    public class SP_Call : ISP_Call
    {
        ...
        public IEnumerable<T> List<T>(string procedureName, DynamicParameters param = null)
        {
            ...
            {
                sqlCon.Open();
                return sqlCon.Query<T>(procedureName, param, commandType:
                System.Data.CommandType.StoredProcedure);
            }
        }
        ...
        DynamicParameters param = null)
        {
            ...
            return new Tuple<IEnumerable<T1>, IEnumerable<T2>>(new List<T1>(), new
            List<T2>());
        }
        public T OneRecord<T>(string procedureName, DynamicParameters param = null)
        {
            ...
            {
                sqlCon.Open();
                var value = sqlCon.Query<T>(procedureName, param, commandType:
                System.Data.CommandType.StoredProcedure);
